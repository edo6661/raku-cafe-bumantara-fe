  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 bg-white p-5 rounded-[20px] shadow-sm border border-slate-200/80">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Dashboard Analitik</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-1 bg-white rounded-[20px] shadow-sm border border-slate-200/80 overflow-hidden flex flex-col">
